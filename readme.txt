...
*   Fully compatible with all other Live Admin plugins (including [WP Getting Started](http://wordpress.org/extend/plugins/wp-getting-started))
...
= 0.2 =
* Fix in loading of language files
